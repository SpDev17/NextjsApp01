        ...
        <header className="bg-purple-200 border-gray-200 dark:bg-gray-900 dark:border-gray-700 rounded-lg">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                ...
                <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400	flex flex-wrap items-center text-base justify-center">
                    ...
                    <Link href={"/dashboards/inventry"} className="mr-5 hover:text-gray-900" aria-current="page">Inventry</Link>
                    ...
                    {objProps['user'] ? <a onClick={objProps.logout} className="mr-5 hover:text-gray-900">Log Out</a> : <Link href={"/login"} scroll={false} className="mr-5 hover:text-gray-900">Login</Link>}
