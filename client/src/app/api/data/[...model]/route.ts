...
export async function GET(req: NextRequest, context: any) {
    try {
        ...
        //console.log(context);
        //http://localhost:3000/api/data/user/get_json?select=id,title&$filter=go
        //console.log('---------------------------------------------------------------');
        ...
        //console.log('---------------------------------------------------------------');
//http://localhost:3000/adminapi/member/get_json?desc=false&limit=10&lookup=%5B%7B%22model%22%3A%22group%22%2C%22select%22%3A%22title%22%2C%22path%22%3A%22groups%22%7D%5D&page=1&search=%22%22&select=%5B%22first_name%22%2C%22last_name%22%2C%22email%22%2C%22mobile%22%2C%22isactive%22%5D&sort=%22email%22
//http://localhost:3000/adminapi/member/get_json?desc=false&limit=10&lookup=[{"model":"group","select":"title","path":"groups"}]&page=1&search=""&select=["first_name","last_name","email","mobile","isactive"]&sort="email"
