...
//mongoose.models = {};
export const GroupPermission: IGroupPermissionModel = <IGroupPermissionModel>mongoose.models['grouppermission'] || model<IGroupPermission, IGroupPermissionModel>('grouppermission', GroupPermissionSchema);
